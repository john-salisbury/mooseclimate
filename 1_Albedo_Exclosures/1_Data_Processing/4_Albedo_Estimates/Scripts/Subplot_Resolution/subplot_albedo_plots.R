...
#INITIAL DATA IMPORT ----------------------------------------------------------------------------------------------
        ...
        albedo_means <- read.csv("1_Albedo_Exclosures/1_Data_Processing/4_Albedo_Estimates/Output/Subplot_Resolution/mean_subplot_albedo.csv", header = T)

        #Mean albedo estimates by treatment AND REGION
        albedo_reg <- read.csv("1_Albedo_Exclosures/1_Data_Processing/4_Albedo_Estimates/Output/Subplot_Resolution/mean_subplot_albedo_by_region.csv", header = T)

        #Mean albedo estimates by treatment AND SITE
        albedo_site <- read.csv("1_Albedo_Exclosures/1_Data_Processing/4_Albedo_Estimates/Output/Subplot_Resolution/mean_subplot_albedo_by_site.csv", header = T)
...
#PLOT ALBEDO - **MEANS - ALL REGIONS**  ---------------------------------------------------------------------------------
        ...
        ggsave('subplot_albedo_all.svg',
               all_means,
               "svg",
               '1_Albedo_Exclosures/1_Data_Processing/4_Albedo_Estimates/Output/Subplot_Resolution/Plots',
               scale = 1.25)
